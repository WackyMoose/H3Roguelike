...
{
    public class CreatureSpeciesCategory
    {
        ...
        public static CreatureSpeciesCategory Moose { get { return new CreatureSpeciesCategory("Moose", 7000, 10000); } }
        ...
        public static List<CreatureSpeciesCategory> List()
        {
            ...
            { 
                Moose, Ork, Elf, Dwarf, Giant, Hobgoblin, Griffin, Minotaur, Centaur, Wolf, 
